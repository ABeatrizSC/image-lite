...
export const Template: React.FC<TemplateProps> = ({ children, loading = false }: TemplateProps) => {
    return (
        <>
            <Header />
            <div className={`${loading ? 'animate-pulse' : ''} container min-h-screen relative mx-auto pt-8 pb-8 px-4`}>
...
const Footer: React.FC = () => {
    return (
        <footer className="bg-indigo-950 text-white py-3 w-full">
            <div className="container mx-auto text-center">
            Desenvolvido por <a href="https://www.github.com/ABeatrizSC" target="_blank" rel="noopener noreferrer">ABeatrizSC</a>
            </div>
        </footer>
    )
} 